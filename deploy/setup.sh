...
apt-get install -y python3-dev python3-venv python-pip-whl supervisor nginx git postgresql-client gcc libc6-dev gcc musl-dev postgresql-dev linux-headers-5.4.0-42-generic 
